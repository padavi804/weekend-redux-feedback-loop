        ...
        <div>
            ...
            <div>
                <form onSubmit={(e) => handleSubmit(e)}>
                    ...
                    >
                        <input data-testid="input" id="outlined-basic" label="1-10" variant="outlined" value={currentUnderstanding} onChange={(evt) => setCurrentUnderstanding(evt.target.value)} />
                    </Box>
